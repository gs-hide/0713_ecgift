...
<body class="cms">
  ...
  <div class="outer">
    ...
    <div class="wrapper wrapper-cms">
      <!--商品選択フォーム-->
      <form action="insert2_sample.php" method="post" class="flex-parent cartin-area cms-area" enctype="multipart/form-data">
        <!--商品情報-->
        ...
        <dl class="cms-list">
          ...
          <dt>金額</dt>
          <dd><input type="text" name="price" placeholder="金額を入力" class="cms-item"></dd>
          <dt>商品紹介文</dt>
