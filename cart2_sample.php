...
//----------------------------------------------------
//1．SESSIONからカートを取得
//※カートSESSION: array([0]=item,[1]=price,[2]=num,[3]=fname);
//----------------------------------------------------
$view ='';
//$_SESSION["cart"]のデータを取得
foreach($_SESSION["cart"] as $key => $value){
      $view .='<li class="cart-list">';
      $view .='<p class="cart-thumb"><img src="./img_sample/'.$value[3].'" width="200"></p>';
      $view .='<h2 class="cart-title">'.$value[0].'</h2>';
      $view .='<p class="cart-price">'.$value[1].'</p>';
      $view .='<p class="cart-number">'.$value[2].'</p>';
      $view .='<a href="cartremove2_sample.php?id='.$key.'" class="btn-delete">削除</a>'; //$key
      $view .='</li>';
}
?>
...
<body>
  ...
  <div class="outer">
    ...
    <div class="wrapper wrapper-main flex-parent">
      <main class="wrapper-main">
        ...
        <ul class="btn-list">
          <li class="btn-item btn-buy"><a href="index2_sample.php">買い物を続ける</a></li>
  ...
  <footer class="footer">
    <div class="wrapper wrapper-footer">
      ...
      <div class="footer-widget">
        <ul class="nav-footer">
          <li class="nav-footer__item"><a href="#">LOCAL DEPARTMENT STORE</a></li>
