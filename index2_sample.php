...
if($status==false) {
  ...
  while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    $view .= '<a href="item2_sample.php?id='.$result["id"].'">';
    $view .= '<p class="pruducts-thumb"><img src="./img_sample/'.$result["fname"].'" width="200"></p>';
    $view .= '<h3 class="products-title">'.$result["item"].'</h3>';
    $view .= '<p class="products-price">'.$result["price"].'</p>';
    $view .= '</a>';
    $view .= '</li>';
  }
}
...
<body>
  <header class="header">
    ...
    <a href="cart2_sample.php" class="btn btn-cart"><img src="images/common/icon-cart.png" alt="G's Academy Tokyo"></a>
  ...
  <div>
    <ul class="bxslider">
      <li><img src="images/index/i_tit01.jpg" alt=""></li>
      <li><img src="images/index/001_tit01.jpg" alt=""></li>
      <li><img src="images/index/002_tit01.jpg" alt=""></li>
      <li><img src="images/index/003_tit01.jpg" alt=""></li>
      <li><img src="images/index/i_tit01.jpg" alt=""></li>
    </ul>
  </div>
  ...
  <div class="outer">
    ...
    <div class="list-outer">
      <ul class="list">
        <li class="list-item"><a href="#">九州からの贈り物</a></li>
        <li class="list-item"><a href="#">九州深発見グルメ</a></li>
        <li class="list-item current"><a href="#">九州うまいもの紀行</a></li>
        <li class="list-item"><a href="#">九州ふるさとグルメ</a></li>
        <li class="list-item"><a href="#">九州チョイス</a></li>
      </ul>
    </div>
    <!--end メインカテゴリー-->
      ...
      <aside class="sidebar">
        ...
        <div class="widget">
          ...
          <ul class="category-list">
            <li class="category-item"><a href="#">九州からの贈り物</a></li>
            <li class="category-item"><a href="#">九州深発見グルメ</a></li>
            <li class="category-item"><a href="#">九州うまいもの紀行</a></li>
            <li class="category-item"><a href="#">九州ふるさとグルメ</a></li>
            <li class="category-item"><a href="#">九州チョイス</a></li>
          </ul>
        </div>
        <!--end category-->
      </aside>
  ...
  <footer class="footer">
    <div class="wrapper wrapper-footer">
      ...
      <div class="footer-widget">
        <ul class="nav-footer">
          <li class="nav-footer__item"><a href="#">九州からの贈り物</a></li>
          <li class="nav-footer__item"><a href="#">九州深発見グルメ</a></li>
          <li class="nav-footer__item"><a href="#">九州うまいもの紀行</a></li>
          <li class="nav-footer__item"><a href="#">九州ふるさとグルメ</a></li>
          <li class="nav-footer__item"><a href="#">九州チョイス</a></li>
        </ul>
      </div>

      <div class="footer-widget">
        <ul class="nav-footer">
          <li class="nav-footer__item"><a href="#">local departmentstore</a></li>
    ...
    <p class="copyrights"><small>Copyrights LOCAL DEPARTMENT STORE All Rights Reserved.</small></p>
  </footer>
  <!--end footer-->
